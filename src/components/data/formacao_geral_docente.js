export const perguntas = [
  ...
  {
    pergunta: "De acordo com Platão, o objetivo principal da educação é:",
    opcoes: [
      "Alfabetizar rapidamente",
      "Reproduzir conteúdos",
      "Formar cidadãos obedientes",
      "Promover a sabedoria acima do prazer"
    ],
    respostaCorreta: 3
  },
  {
    pergunta: "A gestão democrática na escola prevê:",
    opcoes: [
      "Decisões tomadas apenas pelo diretor",
      "Participação coletiva da comunidade escolar",
      "Apenas professores definem regras",
      "Gestão militarizada da escola"
    ],
    respostaCorreta: 1
  },
  {
  ...
  {
    pergunta: "Qual lei institui o Estatuto da Criança e do Adolescente?",
    opcoes: [
      "Lei nº 9.394/96",
      "Lei nº 8.069/90",
      "Lei nº 10.639/03",
  ...
  {
    pergunta: "De acordo com o ECA, a idade para ser considerado adolescente é:",
    opcoes: ["0 a 6 anos", "7 a 12 anos", "12 a 18 anos", "15 a 21 anos"],
    respostaCorreta: 2
  },
  {
    pergunta: "A Declaração Universal dos Direitos Humanos foi criada após:",
    opcoes: [
  ...
  {
    pergunta: "Qual é o principal objetivo da Base Nacional Comum Curricular (BNCC)?",
    opcoes: [
      "Controlar os professores",
      "Estabelecer conteúdos obrigatórios",
      "Promover igualdade na educação básica",
      "Eliminar matérias desnecessárias"
    ],
    respostaCorreta: 2
  },
  {
    pergunta: "Quem criou o conceito de 'zona de desenvolvimento proximal'?",
    opcoes: [
      "Jean Piaget",
      "Lev Vygotsky",
      "Paulo Freire",
  ...
  {
    pergunta: "A Constituição Federal de 1988 define a educação como:",
    opcoes: [
      "Um serviço opcional do Estado",
      "Dever apenas da família",
  ...
  {
    pergunta: "A lei nº 10.639/03 torna obrigatório o ensino de:",
    opcoes: [
      "Educação Ambiental",
  ...
  {
    pergunta: "Qual pensador defendia que o conhecimento vem da experiência sensível?",
    opcoes: [
      "Aristóteles",
      "Platão",
      "Descartes",
  ...
  {
    pergunta: "Qual é o nome do processo de exclusão de alunos por desempenho escolar?",
    opcoes: [
      "Promoção automática",
      "Inclusão escolar",
      "Aprovação por mérito",
      "Exclusão escolar"
    ],
    respostaCorreta: 3
  },
  {
    pergunta: "A sigla LDB se refere a:",
    opcoes: [
      "Lei de Direitos Básicos",
      "Lei da Didática Brasileira",
      "Lei de Diretrizes e Bases da Educação Nacional",
      "Lei de Desenvolvimento Brasileiro"
    ],
    respostaCorreta: 2
  },
  {
    pergunta: "O Plano Nacional de Educação (PNE) estabelece:",
    opcoes: [
      "Metas para a educação básica apenas",
      "Metas e estratégias para toda a educação",
      "Orçamento federal exclusivo para escolas",
      "Formação política de professores"
    ],
    respostaCorreta: 1
  },
  {
    pergunta: "A pedagogia crítica é associada a qual educador?",
    opcoes: [
      "Paulo Freire",
      "Jean Piaget",
      "Lev Vygotsky",
  ...
  {
    pergunta: "Segundo Piaget, o estágio operatório concreto ocorre em qual idade?",
    opcoes: [
      "0 a 2 anos",
      "2 a 7 anos",
      "7 a 11 anos",
  ...
  {
    pergunta: "Qual das opções está entre os princípios da educação na LDB?",
    opcoes: [
  ...
  {
    pergunta: "A Lei nº 13.005/14 trata do:",
    opcoes: [
  ...
  {
    pergunta: "Montessori acreditava que a educação deveria ser:",
    opcoes: [
      "Obrigatória e rígida",
      "Baseada na repetição",
      "Livre e respeitosa ao ritmo da criança",
      "Focada apenas na alfabetização"
    ],
    respostaCorreta: 2
  },
  {
    pergunta: "Qual é o papel principal do professor na perspectiva construtivista?",
    opcoes: [
      "Transmitir conteúdos",
      "Atuar como facilitador do conhecimento",
      "Corrigir o aluno constantemente",
      "Controlar o comportamento dos alunos"
    ],
    respostaCorreta: 1
  },
  {
    pergunta: "Qual filósofo dizia 'só sei que nada sei'?",
    opcoes: [
      "Aristóteles",
      "Platão",
      "Sócrates",
  ...
  {
    pergunta: "A função social da escola é:",
    opcoes: [
      "Apenas preparar para o vestibular",
      "Formar cidadãos críticos e participativos",
      "Proteger as crianças do convívio social",
      "Garantir que todos passem de ano"
    ],
    respostaCorreta: 1
  },
  {
    pergunta: "A Lei nº 11.645/08 alterou a LDB para incluir:",
    opcoes: [
